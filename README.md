...
The source of truth is `controlled_spec.md` and `physical_tests.md`, and AI-assisted stages are constrained by deterministic plan artifacts and execution-time validation.
...
- Sample `advdiff1d` controlled spec at `spec/transport/advection_diffusion/advdiff1d_linear/controlled_spec.md`.
- Sample `advdiff1d` physical tests at `spec/transport/advection_diffusion/advdiff1d_linear/physical_tests.md`.

## Core Workflow (Summary)

1. Define physics and tests in documents (`controlled_spec.md`, `physical_tests.md`).
...
1. Read `spec/transport/advection_diffusion/advdiff1d_linear/controlled_spec.md`.
2. Read `spec/transport/advection_diffusion/advdiff1d_linear/physical_tests.md`.
