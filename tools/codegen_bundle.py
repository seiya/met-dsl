...
# `harness_fortran_cpu@0.3.0` §5.1 (13 operations, 5 published types, `dp = real64`,
# `case_id_len = 64`). Its mechanical enforcer remains
...
HARNESS_CAPABILITY_MANIFESTS: dict[str, frozenset[str]] = {
    "infrastructure/harness_fortran_cpu@0.3.0": frozenset({"sync_single_case@1"}),
}
