...
## 0. メタ情報
- `test_profile_id`: `transport_advection_diffusion_time_update_1d_euler1_l0`
- `test_profile_version`: `0.1.0`
- `status`: `draft`
- `spec_ref.spec_kind`: `component`
- `spec_ref.spec_id`: `transport_advection_diffusion_time_update_1d_euler1`
- `spec_ref.spec_version`: `0.1.0`
- `spec_ref.controlled_spec_path`: `spec/component/transport/advection_diffusion/transport_advection_diffusion_time_update_1d_euler1/controlled_spec.md`

## 1. テスト対象 `operation`
- `transport_advection_diffusion_time_update_1d_euler1__advance`
...
- `test_id`: `l0_zero_gradient_invariance_pass`
  - `level`: `L0`
  - `operation_id`: `transport_advection_diffusion_time_update_1d_euler1__advance`
